...
export async function saveCoinSettings(symbol: string, settings: Partial<CoinSettings>): Promise<void> {
  try {
    ...
    const existingItem = items.find(item => item.symbol === symbol);
